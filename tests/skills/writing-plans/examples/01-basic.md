...
- [ ] 触发: Claude 自动 invoke /writing-plans skill
- [ ] 宣告: "我用 writing-plans skill 写实现计划"
...
- [ ] 步 8: 提示后续 "用 executing-plans skill 执行?"
...
- 反向 (太早): "我想加个登录功能, 但还没想好用啥方案" → **不应**触发 (该走 brainstorming)
- 边界 (已有 plan): "按 docs/plans/2026-05-20-foo.md 继续完善 Task 3" → **不应**触发 (该走 executing-plans)
